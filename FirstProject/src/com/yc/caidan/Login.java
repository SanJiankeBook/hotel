...
import com.yc.productInfo.dao.LoginInfo;
...
public class Login {
	...
	private Text text_1;
	private LoginInfo lg=new LoginInfo();
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(Login.class, "/image/Login.jpg"));
		shell.setBackgroundImage(SWTResourceManager.getImage(Login.class, "/image/Login1.jpg"));
		shell.setBackgroundMode(SWT.INHERIT_DEFAULT);
		shell.setSize(686, 436);
		shell.setText("qq用户登入");
		...
		lblNewLabel.setFont(SWTResourceManager.getFont("Segoe Print", 31, SWT.BOLD));
		...
		button.setBounds(497, 341, 98, 16);
		button.setText("记住密码");
		
		Label label_1 = new Label(composite, SWT.NONE);
		label_1.setBounds(510, 378, 61, 15);
		label_1.setText("忘记密码了？");
		
		Label lblNewLabel_2 = new Label(composite, SWT.NONE);
		lblNewLabel_2.setImage(SWTResourceManager.getImage(Login.class, "/image/btn_close_highlight.png"));
		lblNewLabel_2.setBounds(635, 0, 39, 20);
		
		Label lblNewLabel_3 = new Label(composite, SWT.NONE);

		lblNewLabel_3.setImage(SWTResourceManager.getImage(Login.class, "/image/btn_mini_highlight.png"));
		...
		btnNewButton_1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(pwd.equals(map.get(uname))){//由于我们这个密码和账号是在数据库中操作，所以在这里不要在操作什么
