...
public class Yuyue_1 {
	...
	protected void createContents() {
		...
		shell.setBackgroundImage(SWTResourceManager.getImage(Yuyue_1.class, "/Image/72.jpg"));
		...
		lblNewLabel_4.setBounds(71, 133, 47, 17);
		...
		lblNewLabel_14.setBounds(249, 20, 70, 17);
		lblNewLabel_14.setText(Denglu.chuangzhi());
		...
		lblNewLabel_16.setBounds(316, 100, 35, 17);
		lblNewLabel_16.setText("性别:");
		
		combo = new Combo(shell, SWT.READ_ONLY);
		combo.setBounds(136, 133, 128, 25);
		
		combo_1 = new Combo(shell, SWT.READ_ONLY);
		combo_1.setBounds(357, 97, 88, 25);
		combo_1.add("男");
		combo_1.add("女");
		...
		//按下确定键
				btnNewButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseDown(MouseEvent e) {
						...
						int count=1;
						List<Map<String,Object>> lmap= new ArrayList<Map<String, Object>>();
						String str11=combo.getText().trim();//获取房号
						...
						if(count==1 && Integer.parseInt(num)>0){
							...
							if((!fj.equals("")&& fj!=null)&&(!type.equals("")&& type!=null)&&(!xingming.equals("")&& xingming!=null)&&(!sex.equals("")&& sex!=null)&&(!liangxi.equals("")&&liangxi!=null)&&(!shenfen.equals("")&& shenfen!=null)&&(!yudi.equals("")&& yudi!=null)&&(!yuli.equals("")&& yuli!=null)&&(!num.equals("")&& num!=null)&&(!price.equals("")&& price!=null)&&(!Denglu.chuangzhi().equals("")&& Denglu.chuangzhi()!=null)){
								...
								DataInfo.isNumber=1;
								qtinfo.updateState("预定",combo.getText().trim());
